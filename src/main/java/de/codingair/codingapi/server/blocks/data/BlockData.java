...
public abstract class BlockData {
    ...
    public void setTypeAndDataTo(Block block, Material material, byte data, boolean applyPhysics) {
        if(Version.after(12)) throw new IllegalStateException("setTypeIdAndData() cannot be set in v1.13+");
    ...
    public int getTypeId(Material material) {
        if(Version.after(12)) throw new IllegalStateException("getTypeId() cannot be set in v1.13+");
