package de.CodingAir.v1_6.CodingAPI.Server.ParticleMessages;
...
public class ParticleMessage {
	...
	private de.CodingAir.v1_6.CodingAPI.Tools.Location loc;
	private int scheduler;
	private double height, length;
	
	
	public ParticleMessage(Plugin plugin, String message, Particle particle, de.CodingAir.v1_6.CodingAPI.Tools.Location loc, double height, double length, ParticleFont font, ParticleChar.Direction direction) {
	...
	private void Spawn(Character c, double x, double y, double z) {
		...
		de.CodingAir.v1_6.CodingAPI.Tools.Location loc = new de.CodingAir.v1_6.CodingAPI.Tools.Location(new Location(this.loc.getWorld(), x, y, z));
